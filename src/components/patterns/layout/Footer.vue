  ...
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
      ...
      <div class="mt-10 flex justify-center space-x-10">
        ...
        <button class="icon-btn mx-2 !outline-none text-gray-400 hover:text-gray-500" :title="t('button.toggle_dark')" @click="toggleDark()">
          <div i="carbon-sun dark:carbon-moon" />
        </button>
        <a class="icon-btn mx-2 text-gray-400 hover:text-gray-500" :title="t('button.toggle_langs')" @click="toggleLocales()">
